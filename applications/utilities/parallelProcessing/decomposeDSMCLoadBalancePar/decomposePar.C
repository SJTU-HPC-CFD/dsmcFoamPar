...
int main(int argc, char *argv[])
{
    ...
    // This utility is invoked as a one-shot repartition helper. With the
    // current v2506 registry/lifetime mix, normal process teardown can double
    // free cached mesh/lagrangian objects after all output has already been
    // written. Exit directly with success after flushing the final message.
    std::_Exit(0);
}
