...
:
    ...
    d1_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "d1"))),
    d2_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "d2"))),
    n1_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "n1"))),
    n2_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "n2"))),
    area_(0.0)
{
    n1_ /= mag(n1_);
    n2_ /= mag(n2_);
