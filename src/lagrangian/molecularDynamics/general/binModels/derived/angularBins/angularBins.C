...
//     Foam::hyCompat::lookup(rotationalAxis_(Foam::hyCompat::lookup(propsDict_, "rotationalAxis"))),
    m_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "centrePoint"))),
    rVx_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "referenceVectorX"))),
    rVy_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "referenceVectorY"))),
    Rin_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "Rin"))),
    Rout_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "Rout"))),
    thetaStart_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "angleStart"))),
    thetaEnd_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "angleEnd"))),

//     Foam::hyCompat::lookup(startPoint_(Foam::hyCompat::lookup(propsDict_, "startPoint"))),
//     Foam::hyCompat::lookup(endPoint_(Foam::hyCompat::lookup(propsDict_, "endPoint"))),
...
//     binWidth_((thetaStart_ - thetaEnd_)/nBins_),
    area_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "thickness"))),
    counterClockWise_(false)
{
    ...
    {
        counterClockWise_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "counterClockWise")));
    }
}
