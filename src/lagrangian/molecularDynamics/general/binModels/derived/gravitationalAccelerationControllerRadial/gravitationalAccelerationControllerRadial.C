...
:
    ...
    rotationalAxis_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "rotationalAxis"))),
    m_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "rotationalPoint"))),
...
//     Foam::hyCompat::lookup(radius_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "radius")))),
    ...
    acc_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "acceleration")))
{
