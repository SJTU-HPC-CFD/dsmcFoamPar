...

{
    ...
    {
        tolerance = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "tolerance"));
    }
    ...
    )
    {
        ...
        rotationStartPoint_ = Foam::hyCompat::lookup(propsDict_, "rotationAxisStartPoint");
        rotationEndPoint_ = Foam::hyCompat::lookup(propsDict_, "rotationAxisEndPoint");
...
//         rotationPt_ = Foam::hyCompat::lookup(propsDict_, "rotationPoint");
