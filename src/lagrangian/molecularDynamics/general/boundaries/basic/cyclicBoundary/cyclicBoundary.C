...
//     RBA_(tensor::zero),
{
    const word patchName = Foam::hyCompat::lookup(boundaryDict_, "patchName");
    ...
    boundaryPoints_ = List<vector>(Foam::hyCompat::lookup(Foam::hyCompat::lookup(boundaryDict_, "boundaryPoints")));
    ...
    nF_ = Foam::hyCompat::lookup(boundaryDict_, "normal");

    nFaces_ = (Foam::hyCompat::toLabel(Foam::hyCompat::lookup(boundaryDict_, "nFaces")));


    //- Neighbour patch

    const word neighbPatchName = Foam::hyCompat::lookup(boundaryDict_, "neighbourPatchName");
...
{
    word cyclicBoundaryName(Foam::hyCompat::lookup(dict, "cyclicBoundaryModel"));
