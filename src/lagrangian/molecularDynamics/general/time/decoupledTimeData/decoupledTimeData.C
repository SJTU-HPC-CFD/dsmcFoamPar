...
:
    ...
    contWriteInterval_(Foam::hyCompat::toScalar(continuumTime_.controlDict(), "writeInterval")),
    molWriteInterval_(Foam::hyCompat::toScalar(molecularTime_.controlDict(), "writeInterval")),
...
:
    ...
    contWriteInterval_(Foam::hyCompat::toScalar(continuumTime_.controlDict(), "writeInterval")),
    molWriteInterval_(Foam::hyCompat::toScalar(molecularTime_.controlDict(), "writeInterval")),
    contCouplingTimeInterval_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(couplingTimeDict_, "continuumCouplingTimeInterval"))),
    molCouplingTimeInterval_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(couplingTimeDict_, "molecularCouplingTimeInterval"))),
    molecularTimeInt_
    (
        label
        (
