...
:
    time_(t),
    timeDict_(),
    writeInterval_(Foam::hyCompat::toScalar(t.controlDict(), "writeInterval")),
...
:
    ...
    resetIndex_(0),
    mdTime_(1),
    samplingTime_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nSamples"))),
    averagingTime_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nAverages"))),
//     Foam::hyCompat::lookup(calcPropTime_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nCalcProp")))),
    controlTime_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nControls"))),
    nAvTimeSteps_("nAvTimeSteps_", dimless, 0.0),
    nControlSteps_(0.0),
    totalNSampSteps_(0),
    totalNAvSteps_(0),
...
//     averagingTimes_()
{
    ...
    {
        decoupledFromWriteInterval_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(timeDict, "decoupledFromWriteInterval")));
    }
...
void timeData::setInitialData()
{
    ...
    {
        resetFieldsAtOutput_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(timeDict_, "resetAtOutput")));
    }
...
//     const label nCalcProp(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nCalcProp")));
    const label nControls(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nControls")));
