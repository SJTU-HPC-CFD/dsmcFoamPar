...
:
    ...
    couplingTimeDict_(),
    writeInterval_(Foam::hyCompat::toScalar(continuumTime_.controlDict(), "writeInterval")),
...
:
    ...
    writeInterval_(Foam::hyCompat::toScalar(continuumTime_.controlDict(), "writeInterval")),
    couplingTimeInterval_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(couplingTimeDict_, "couplingTimeInterval"))),
    molecularTimeInt_
    (
        label
        (
            couplingTimeInterval_/
            Foam::hyCompat::toScalar(molecularTime.controlDict(), "deltaT")
        ),
        couplingTimeInterval_
    ),
    continuumTimeInt_
    (
        ...
        (
            couplingTimeInterval_/
            Foam::hyCompat::toScalar(continuumTime.controlDict(), "deltaT")
        ),
        couplingTimeInterval_
    ),
    molecularTimeOn_
    ...
    continuumSolution_(false),
    molecularSolution_(false),
    couplingOption_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(couplingTimeDict_, "couplingOption"))),
    decoupledScheme_(false),
    molecularSwitch_(true),
    runSequential_(true)
{

    scalar deltaTC = Foam::hyCompat::toScalar(continuumTime_.controlDict(), "deltaT");
    scalar deltaTMD = Foam::hyCompat::toScalar(molecularTime_.controlDict(), "deltaT");
    ...
    {
        runSequential_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(couplingTimeDict_, "runSequential")));
    ...
    else if(couplingOption_ == "decoupled")
    {
        ...
        scalar molecularOnInterval = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(couplingTimeDict_, "molecularOnInterval"));
    ...
    //- write interval
    scalar molecularWriteInterval = Foam::hyCompat::toScalar(molecularTime_.controlDict(), "writeInterval");
...
//
//     scalar deltaTMD = Foam::hyCompat::toScalar(time_.controlDict(), "deltaT");
//
...
//     {
//         const label nSamples = Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict_, "nSamples"));
//         const label nAverages = Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict_, "nAverages"));
//
...
// {
//     const label nSamples(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nSamples")));
//     const label nAverages(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nAverages")));
// //     const label nCalcProp(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(timeDict, "nCalcProp")));
//
//
//     samplingTime_.nSteps() = nSamples;
//     averagingTime_.nSteps() = nAverages;
