...
:
    ...
    offsetTime_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "offsetTime"))),
//     Foam::hyCompat::lookup(deltaT_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "deltaT")))),
//     elapsedTime_(0.0),
//     index_(0),
//     times_(),
    forces_()
...

{
    ...
    const word distributionName = propsDict_.get<word>("forceDistributionName");
