...
:
    ...
    force_(vector::zero),
    direction_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "forceDirection"))),
    initialForce_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "forceAtTimeZero"))),
    finalForce_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "forceAtRampEndTime"))),
    endTime_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "rampEndTime"))),
    ...
    deltaTMD_(time.deltaT().value())
{
    ...
    {
        relaxationTime_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "relaxationTime"));

        bool fixGradient = false;

        if (propsDict_.found("fixGradient"))
        {
            fixGradient = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "fixGradient")));
        }
    ...
    {
        bool acrossMultipleRuns = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "acrossMultipleRuns")));
