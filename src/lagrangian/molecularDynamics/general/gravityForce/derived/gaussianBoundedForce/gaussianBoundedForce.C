...
)
{
    ...
    vector startPoint = Foam::hyCompat::lookup(dict, "startPoint");
    vector endPoint = Foam::hyCompat::lookup(dict, "endPoint");
...
//     Foam::hyCompat::lookup(stress_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "stress")))),
    amplitude_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "gaussianAmplitude"))),
//     Foam::hyCompat::lookup(density_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "numberDensity")))),
//     constantA_(0.0),
    constantB_(0.0),
    forceDirection_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "forceDirection")))
{
    forceDirection_ /= mag(forceDirection_);

    scalar tF = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "thickness"));
...
//     constantA_ = sqrt(2.0/mathematicalConstant::pi)/sigma;
    ...
    {
        output = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "output")));

        if(output)
        {
            const word fieldName = Foam::hyCompat::lookup(propsDict_, "fieldName");
            scalar nBins = Foam::hyCompat::toLabel(Foam::hyCompat::lookup(propsDict_, "nBins"));
...
//     stress_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "stress"));
}
