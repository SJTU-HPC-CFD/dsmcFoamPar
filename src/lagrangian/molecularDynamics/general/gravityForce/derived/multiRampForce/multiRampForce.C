...
:
    ...
    loadingTime_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "loadingTime"))),
    breathingTime_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "breathingTime"))),
    noOfStops_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(propsDict_, "noOfStops"))),
    currentTime_(0.0),
    timeLoading_(0.0),
    timeBreathing_(0.0),
