...
:
    ...
    initialForce_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "initialForce"))),
    finalForce_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "finalForce"))),
    initialTime_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "initialTime"))),
    ...
    deltaTMD_(time.deltaT().value())
{
    ...
    {
        relaxationTime_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "loadingTime"));
    }
//
