...
//     Foam::hyCompat::lookup(amplitude_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "gaussianAmplitude")))),
    density_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "numberDensity"))),
    constantA_(0.0),
    constantB_(0.0),
