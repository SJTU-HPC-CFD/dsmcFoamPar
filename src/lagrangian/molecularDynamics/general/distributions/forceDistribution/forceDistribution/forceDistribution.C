...
//     Foam::hyCompat::lookup(fileName_(dict, "fileName")),
    fileName_("forceDistributions"),
    startPoint_(Foam::hyCompat::lookup(dict, "startPoint")),
    endPoint_(Foam::hyCompat::lookup(dict, "endPoint")),
    unitVector_
    (
        (endPoint_- startPoint_)/
        mag(endPoint_- startPoint_)
    ),
    noOfBins_(Foam::hyCompat::toLabel(dict, "noOfBins")),
...
{
    const word name(Foam::hyCompat::lookup(dict, "distributionName"));
    const vector startPoint(Foam::hyCompat::lookup(dict, "startPoint"));
    const vector endPoint(Foam::hyCompat::lookup(dict, "endPoint"));
    const label noOfBins(Foam::hyCompat::toLabel(dict, "noOfBins"));
