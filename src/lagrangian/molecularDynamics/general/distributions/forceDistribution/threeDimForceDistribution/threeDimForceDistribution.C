...
:
    name_(Foam::hyCompat::lookup(dict, "distributionName")),
    fileName_("forceDistributions"),
    startPoint_(Foam::hyCompat::lookup(dict, "startPoint")),
    lengthX_(Foam::hyCompat::toScalar(dict, "lengthX")),
    lengthY_(Foam::hyCompat::toScalar(dict, "lengthY")),
    lengthZ_(Foam::hyCompat::toScalar(dict, "lengthZ")),
    unitVectorX_(Foam::hyCompat::lookup(dict, "unitVectorX")),
    unitVectorY_(Foam::hyCompat::lookup(dict, "unitVectorY")),
    unitVectorZ_(Foam::hyCompat::lookup(dict, "unitVectorZ")),
    nBinsX_(Foam::hyCompat::toLabel(dict, "nBinsX")),
    nBinsY_(Foam::hyCompat::toLabel(dict, "nBinsY")),
    nBinsZ_(Foam::hyCompat::toLabel(dict, "nBinsZ")),
    binWidthX_(0.0),
    binWidthY_(0.0),
    binWidthZ_(0.0),
    mols_(nBinsX_),
