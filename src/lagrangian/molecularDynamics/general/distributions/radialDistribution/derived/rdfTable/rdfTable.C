...
//     rdf_()
{
//     word rdfName(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "name")));
//
//     readFromFile_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "readFromFile")));
//
//     if(!readFromFile_)
//     {
