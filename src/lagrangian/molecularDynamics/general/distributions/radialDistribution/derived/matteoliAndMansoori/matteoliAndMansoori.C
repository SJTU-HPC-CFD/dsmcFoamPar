...
:
    ...
    T_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "temperature"))),
    ...
    theta_(0.0)
{
    ...
    {
        readCoefficients_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "readCoefficients")));
    ...
    {
        reducedUnits_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "reducedUnits")));
    }
...
{
    h_ = Foam::hyCompat::toScalar(dict, "h");
    m_ = Foam::hyCompat::toScalar(dict, "m");
    gd_ = Foam::hyCompat::toScalar(dict, "gd");
    lambda_= Foam::hyCompat::toScalar(dict, "lambda");
    alpha_ = Foam::hyCompat::toScalar(dict, "alpha");
    beta_ = Foam::hyCompat::toScalar(dict, "beta");
    theta_ = Foam::hyCompat::toScalar(dict, "theta");
