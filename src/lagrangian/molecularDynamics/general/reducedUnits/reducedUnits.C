...
{
    reducedUnits_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(reducedUnitsDict, "reducedUnits")));

    outputSI_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(reducedUnitsDict, "outputSI")));

    refLength_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(reducedUnitsDict, "refLength"));

    refTime_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(reducedUnitsDict, "refTime"));

    refMass_  = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(reducedUnitsDict, "refMass"));

    refCharge_  = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(reducedUnitsDict, "refCharge"));
