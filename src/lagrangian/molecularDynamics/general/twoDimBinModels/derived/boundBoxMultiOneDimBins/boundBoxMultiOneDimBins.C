...
:
    ...
    startPoint_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(outerDict_, "startPoint"))),
    endPoint_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(outerDict_, "endPoint"))),

    unitVector_((endPoint_ - startPoint_)/mag(endPoint_ - startPoint_)),

    nBins_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(outerDict_, "nBins"))),
    binWidth_(mag(endPoint_ - startPoint_)/(nBins_)),

    d1_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(outerDict_, "d1"))),
    d2_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(outerDict_, "d2"))),
    n1_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(outerDict_, "n1"))),
    n2_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(outerDict_, "n2"))),

    //inner bound boxes

    innerDict_(propsDict_.subDict("innerBoundBoxes")),

    nBinsY_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(innerDict_, "nBins")))
//     Foam::hyCompat::lookup(unitVectorY_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(innerDict_, "direction"))))
