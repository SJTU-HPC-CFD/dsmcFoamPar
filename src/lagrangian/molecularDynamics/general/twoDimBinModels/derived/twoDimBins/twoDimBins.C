...
:
    ...
    unitVectorX_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "unitVectorX"))),
    unitVectorY_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "unitVectorY"))),

    nBinsX_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(propsDict_, "nBinsX"))),
    nBinsY_(Foam::hyCompat::toLabel(Foam::hyCompat::lookup(propsDict_, "nBinsY"))),

    dX_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "dX"))),
    dY_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "dY"))),
