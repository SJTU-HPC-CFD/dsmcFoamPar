    ...
    rU_(rU)
{
    ...
    List<word> idList = Foam::hyCompat::lookup(dict, "idList");
    ...
    forAll(names_, i)
    {
        if(Foam::hyCompat::indexOf(names_, idList[i]) != -1)
        {
    ...
    PtrList<entry> molList(Foam::hyCompat::lookup(dict, "moleculeProperties"));
    ...
    forAll(molList, i)
    {
        ...
        const word cloudTypeI = Foam::hyCompat::lookup(subDict, "cloudType");
        cloudTypes_[i] = cloudTypeI;
        List<word> siteIdNames = Foam::hyCompat::lookup(subDict, "siteIds");
        ...
        {
            if(Foam::hyCompat::indexOf(siteIdList, siteIdNames[j]) == -1)
            {
        ...
        List<label> pairIds = Foam::hyCompat::lookup(subDict, "pairPotentials");
        ...
        forAll(pairIds, j)
        {
            ...
            else if(pairIds[j] == 1)
            {
                ...
                if(Foam::hyCompat::indexOf(pairPotentialSiteIdList, siteNames_[i][j]) == -1)
                {
        ...
        List<vector> siteRefPositions = Foam::hyCompat::lookup(subDict, "siteReferencePositions");
        ...
        List<scalar> siteMasses = Foam::hyCompat::lookup(subDict, "siteMasses");
        ...
        List<scalar> siteCharges = Foam::hyCompat::lookup(subDict, "siteCharges");
        ...
        forAll(siteCharges, j)
        {
            ...
            {
                if(Foam::hyCompat::indexOf(chargeSiteIdList, siteNames_[i][j]) == -1)
                {
    ...
    forAll(siteNames_, i)
    {
        ...
        forAll(siteNames_[i], j)
        {
            ...
            label k = Foam::hyCompat::indexOf(siteIdList_, name);
...
{
    label id = Foam::hyCompat::indexOf(names_, idName);
