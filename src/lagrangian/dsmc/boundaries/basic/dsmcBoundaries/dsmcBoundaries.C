...
:
    ...
    patchBoundaryList_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(dsmcBoundariesDict_, "dsmcPatchBoundaries"))),
    ...
    cyclicBoundaryList_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(dsmcBoundariesDict_, "dsmcCyclicBoundaries"))),
    ...
    generalBoundaryList_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(dsmcBoundariesDict_, "dsmcGeneralBoundaries"))),
...
// 						patchBoundaryModels_[p]->writeField();
...

        {
            ...
            patchBoundaryList_ = Foam::hyCompat::lookup(dsmcBoundariesDict_, "dsmcPatchBoundaries");
...

        {
            ...
            cyclicBoundaryList_ = Foam::hyCompat::lookup(dsmcBoundariesDict_, "dsmcCyclicBoundaries");
...

        {
            ...
            generalBoundaryList_ = Foam::hyCompat::lookup(dsmcBoundariesDict_, "dsmcGeneralBoundaries");
