...
void dsmcReflectiveParticleMembranePatch::readProperties()
{
    /*specularReflectionProb_ =
        Foam::hyCompat::lookup(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "reflectionProbability")));*/
}
...
void dsmcReflectiveParticleMembranePatch::setProperties()
{
    ...
    forAll(moleculesReduced, i)
    {
        ...
        const label typeId(Foam::hyCompat::indexOf(cloud_.typeIdList(), moleculeName));
    ...
    {
        specularReflectionProbs_[i] = Foam::hyCompat::toScalar
        (
            Foam::hyCompat::lookup
            (
...
:
    ...
    specularReflectionProb_
    (
        0 //Foam::hyCompat::lookup(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "reflectionProbability")))
    ),
...
{
    const label& iD = Foam::hyCompat::indexOf(typeIds_, p.typeId()); // NEW VINCENT
    ...
    const label fA = Foam::hyCompat::indexOf(coupledFacesA_, faceI);
    const label fB = Foam::hyCompat::indexOf(coupledFacesB_, faceI);
