...
void dsmcChapmanEnskogFreeStreamInflowPatch::setProperties()
{
    ...
    rotationalTemperature_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "rotationalTemperature"));
    vibrationalTemperature_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "vibrationalTemperature"));

    shearStressXComponents_ = propsDict_.get<vector>("shearStressXComponents");
    shearStressYComponents_ = propsDict_.get<vector>("shearStressYComponents");
    shearStressZComponents_ = propsDict_.get<vector>("shearStressZComponents");
