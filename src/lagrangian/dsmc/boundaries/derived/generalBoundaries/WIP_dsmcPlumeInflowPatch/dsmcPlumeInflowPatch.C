...
:
    ...
    typeIds_(),
    axialVelocity_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "axialVelocity"))),
    radialVelocity_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "radialVelocity"))),
    origin_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "origin"))),
    numberDensities_(),
    accumulatedParcelsToInsert_(),
    inletVelocities_(),
    translationalT_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "translationalTemperature"))),
    rotationalT_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "rotationalTemperature"))),
    vibrationalTemperatures_(),
    electronicT_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "electronicTemperature")))
...
//         Info << "velocity = " << inletVelocities_[f] << endl;
    ...
    {
        vibrationalTemperatures_[i] = Foam::hyCompat::toScalar
        (
            vibrationalTemperaturesDict, moleculesReduced[i]
        );
    }
