    ...
    propsDict_(dict.subDict(typeName + "Properties"))
{
    ...
    wallVelocity_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "velocity"));
    referenceTemperature_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "referenceTemperature"));
    rotationAxis_ = propsDict_.get<vector>("rotationAxis");
    centrePoint_ = propsDict_.get<vector>("centrePoint");
