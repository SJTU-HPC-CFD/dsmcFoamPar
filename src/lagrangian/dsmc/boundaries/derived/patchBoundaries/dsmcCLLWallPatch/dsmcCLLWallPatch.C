...
:
	...
	vibrationalEnergyAccommodationCoefficient_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "vibrationalEnergyAccommodationCoefficient")))
{
...
void dsmcCLLWallPatch::setProperties()
{
    ...
    temperature_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "temperature"));
}
