...
void dsmcRadiationWallFieldPatch::setProperties()
{
    ...
    resetFieldsAtOutput_ = Foam::hyCompat::lookup(propsDict_, "resetAtOutput");
    ...
    alpha_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "energyAccommodationCoeff"));
