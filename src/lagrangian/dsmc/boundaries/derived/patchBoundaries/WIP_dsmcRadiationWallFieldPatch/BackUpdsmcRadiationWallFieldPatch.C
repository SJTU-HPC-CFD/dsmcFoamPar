...
void dsmcRadiationWallFieldPatch::setProperties()
{
    ...
    scalar epsilon = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "emissivity"));
    scalar sigma = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "stefanBoltzmann"));

    epsilonSigma_ = epsilon* sigma;

    thermalCapacity_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "thermalCapacity"));

    alpha_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "alpha"));
    ...
    {
        time_.resetFieldsAtOutput() = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(timeDict_, "resetAtOutput")));
    }
}
