...
#include "dsmcCLLWallFieldPatch.H"
...
defineTypeNameAndDebug(dsmcCLLWallFieldPatch, 0);

addToRunTimeSelectionTable(dsmcPatchBoundary, dsmcCLLWallFieldPatch, dictionary);
...
dsmcCLLWallFieldPatch::dsmcCLLWallFieldPatch
(
    Time& t,
    const polyMesh& mesh,
    dsmcCloud& cloud,
...
:
    ...
    normalAccommodationCoefficient_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "normalAccommodationCoefficient"))),
    tangentialAccommodationCoefficient_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "tangentialAccommodationCoefficient"))),
    rotationalEnergyAccommodationCoefficient_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "rotationalEnergyAccommodationCoefficient"))),
    boundaryT_
    (
        volScalarField
        (
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void dsmcCLLWallFieldPatch::initialConfiguration()
{
...
void dsmcCLLWallFieldPatch::calculateProperties()
{
...
void dsmcCLLWallFieldPatch::output
(
...
void dsmcCLLWallFieldPatch::updateProperties(const dictionary& newDict)
{
...
void dsmcCLLWallFieldPatch::setProperties()
{
}
