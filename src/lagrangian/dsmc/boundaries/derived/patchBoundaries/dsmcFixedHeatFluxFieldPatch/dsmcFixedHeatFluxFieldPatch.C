...
void dsmcFixedHeatFluxFieldPatch::calculateProperties()
{
    ...
    if(stepCounter_ >= nSamples_)
    {
        ...
        PtrList<entry> patchBoundaryList(Foam::hyCompat::lookup(Foam::hyCompat::lookup(newBoundariesDict, "dsmcPatchBoundaries")));
        ...
        forAll(patchBoundaryModels, p)
        {
            ...
            const word patchName = patchNameDict.get<word>("patchName");
...
//         + cloud_.constProps(typeId).electronicEnergyList()[ELevel];
    ...
    label faceId = Foam::hyCompat::indexOf(faces_, p.face());
...
void dsmcFixedHeatFluxFieldPatch::setProperties()
{
    ...
    temperature_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "initialTemperature"));
    desiredHeatFlux_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "desiredHeatFlux"));
    relaxationFactor_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "relaxationFactor"));
    nSamples_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "nWallSamples"));
    referenceCp_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "referenceSpecificHeat"));
    referenceRho_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "referenceDensity"));
    referenceU_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "referenceVelocity"));
    referenceTemperature_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "referenceTemperature"));
    resetAtOutput_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "resetWallSamples")));
}
