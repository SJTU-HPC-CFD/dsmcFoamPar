...
void dsmcDeletionPatch::setProperties()
{
    ...
    {
        allSpecies_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "allSpecies")));
    }
...
:
    ...
    //timeIndex_(0),
    //Foam::hyCompat::lookup(writeInterval_(Foam::hyCompat::toScalar(t.controlDict(), "writeInterval"))),
...
void dsmcDeletionPatch::controlParticle
(
    dsmcParcel& p,
    dsmcParcel::trackingData& td
)
{
//     if(allSpecies_ || (Foam::hyCompat::indexOf(typeIds_, p.typeId()) != -1) )
//     {
