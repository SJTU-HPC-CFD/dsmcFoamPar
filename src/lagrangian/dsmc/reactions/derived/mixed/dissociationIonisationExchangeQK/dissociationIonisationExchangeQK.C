...
#include "dissociationIonisationExchangeQK.H"
...
defineTypeNameAndDebug(dissociationIonisationExchangeQK, 0);
...
void dissociationIonisationExchangeQK::setProperties()
{
...
dissociationIonisationExchangeQK::dissociationIonisationExchangeQK
(
    const Time& t,
    dsmcCloud& cloud,
...
void dissociationIonisationExchangeQK::initialConfiguration()
{
...
bool dissociationIonisationExchangeQK::tryReactMolecules
(
    const label& typeIdP,
    const label& typeIdQ
)
...
void dissociationIonisationExchangeQK::reaction
(
    dsmcParcel& p,
    dsmcParcel& q,
...
void dissociationIonisationExchangeQK::reaction(dsmcParcel& p, dsmcParcel& q)
{
    ...
    else
    {
        ...
        dissociationIonisationExchangeQK::reaction(q, p);
    }
}
...
void dissociationIonisationExchangeQK::outputResults(const label& counterIndex)
{
