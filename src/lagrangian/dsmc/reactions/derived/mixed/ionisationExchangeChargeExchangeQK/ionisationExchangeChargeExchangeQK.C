...
#include "ionisationExchangeChargeExchangeQK.H"
...
defineTypeNameAndDebug(ionisationExchangeChargeExchangeQK, 0);
...
void ionisationExchangeChargeExchangeQK::setProperties()
{
...
ionisationExchangeChargeExchangeQK::ionisationExchangeChargeExchangeQK
(
    Time& t,
    dsmcCloud& cloud,
...
void ionisationExchangeChargeExchangeQK::initialConfiguration()
{
...
bool ionisationExchangeChargeExchangeQK::tryReactMolecules
(
    const label& typeIdP,
    const label& typeIdQ
)
...
void ionisationExchangeChargeExchangeQK::reaction
(
    dsmcParcel& p,
    dsmcParcel& q,
...
void ionisationExchangeChargeExchangeQK::reaction(dsmcParcel& p, dsmcParcel& q)
{
    ...
    else
    {
        ...
        ionisationExchangeChargeExchangeQK::reaction(q, p);
    }
}


inline label ionisationExchangeChargeExchangeQK::nReactionsPerTimeStep() const
{
...
void ionisationExchangeChargeExchangeQK::outputResults
(
