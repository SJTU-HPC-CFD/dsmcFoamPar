...
void associativeIonisationQK::setProperties()
{
    ...
    intermediateMoleculeId_ =
        Foam::hyCompat::indexOf(cloud_.typeIdList(), intermediateMolecule);
    ...
    const wordList productsAssociativeIonisation(Foam::hyCompat::lookup(propsDict_, "associativeIonisationProducts"));
