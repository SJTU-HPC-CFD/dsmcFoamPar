...
{
    const word collisionPartnerSelectionName
    (
        dict.get<word>("collisionPartnerSelectionModel")
    );

    Info<< "Selecting collisionPartnerSelectionModel "
         << collisionPartnerSelectionName << endl;

    auto* ctorPtr = dictionaryConstructorTable(collisionPartnerSelectionName);
