    ...
    resetFieldsAtOutput_(true)
{
    ...
    if(!readTemperatures)
    {
        scalar startTemperature = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "startTemperature"));
        scalar endTemperature = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "endTemperature"));
    ...
    {
        List<scalar> temperatures(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "temperatures")));
    ...
    {
        resetFieldsAtOutput_= Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "resetFieldsAtOutput")));
    }
}
