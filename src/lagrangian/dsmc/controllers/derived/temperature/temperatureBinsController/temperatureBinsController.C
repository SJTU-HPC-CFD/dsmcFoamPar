...
:
    ...
    startTemperature_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "startTemperature"))),
    endTemperature_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "endTemperature"))),
    ...
    chi_(nBins_, 0.0)
{
    ...
    {
        componentControl_ = Switch(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "componentControl")));
    ...
    if(timeVel_.samplingTime())
    {
        ...
        forAll(cells, c)
        {
            ...
            forAll(molsInCell, mIC)
            {
                ...
                {
                    if(Foam::hyCompat::indexOf(typeIds_, p->typeId()) != -1)
                    {
