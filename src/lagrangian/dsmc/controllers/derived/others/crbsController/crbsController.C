...
namespace Foam
{
    ...
    accelerationDirection_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "accelerationDirection"))),
    referenceTemperature_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "referenceTemperature"))),
    waveNumber_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "waveNumber"))),
    frequency_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "frequency"))),
    nTimeSteps_(0.0),
    currentTime_(0.0),
    initialXPositions_()
    {
    ...
    {
        accelerationDirection_ = propsDict_.get<vector>("accelerationDirection");
        waveNumber_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "waveNumber"));
        frequency_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "frequency"));
        referenceTemperature_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "referenceTemperature"));
    }
