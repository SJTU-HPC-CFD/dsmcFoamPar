...
namespace Foam
{
    ...
    porosity_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "porosity"))),
    temperature_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "surfaceTemperature")))
    {
