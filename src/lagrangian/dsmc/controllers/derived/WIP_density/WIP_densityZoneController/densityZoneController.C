            ...
            if( mag(nMolsCumul) < mag(nMolsMesh) )
            {
                ...
                for (label n = 0; n < mag(residualMols); n++)
                {
                    ...
                    while(!foundCell)
                    {
                        ...
                        if( Foam::hyCompat::indexOf(cellsChosen, cellId) == -1)
                        {
...
{
    word typeIdName = Foam::hyCompat::lookup(propsDict_, "typeId");
    typeId_ = Foam::hyCompat::indexOf(cloud_.typeIdList(), typeIdName);
    ...
    targetParcelDensity_ = Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "massDensity"));
