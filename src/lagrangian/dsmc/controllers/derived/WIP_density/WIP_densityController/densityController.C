...
:
    ...
    typeId_(-1),
    density_(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(propsDict_, "massDensity"))),
    velocity_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(propsDict_, "velocity"))),
...
void densityController::setProperties()
{
    ...
    const word typeId = Foam::hyCompat::lookup(propsDict_, "typeId");
    typeId_ = Foam::hyCompat::indexOf(cloud_.typeIdList(), typeId);
