...
:
    ...
    nFluxControllers_(0),
	  ...
	  stateControllersList_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(dsmcControllersDict_, "dsmcStateControllers"))),
    ...
    fluxControllersList_(Foam::hyCompat::lookup(Foam::hyCompat::lookup(dsmcControllersDict_, "dsmcFluxControllers"))),
...
void dsmcControllers::outputResults()
{
    ...
    if(runTime.outputTime())
    {
...

        {
            ...
            stateControllersList_ = Foam::hyCompat::lookup(dsmcControllersDict_, "dsmcStateControllers");
...

        {
            ...
            fluxControllersList_ = Foam::hyCompat::lookup(dsmcControllersDict_, "dsmcFluxControllers");
