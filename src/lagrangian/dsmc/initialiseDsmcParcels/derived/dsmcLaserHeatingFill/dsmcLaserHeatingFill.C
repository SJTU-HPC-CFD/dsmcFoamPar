...
//     (
//         Foam::hyCompat::lookup(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(dsmcInitialiseDict_, "translationalTemperature")))
//     );
//
//     const scalar rotationalTemperature
//     (
//         Foam::hyCompat::lookup(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(dsmcInitialiseDict_, "rotationalTemperature")))
//     );
//
//     const scalar vibrationalTemperature
//     (
//         Foam::hyCompat::lookup(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(dsmcInitialiseDict_, "vibrationalTemperature")))
//     );
//
//     const scalar electronicTemperature
//     (
//         Foam::hyCompat::lookup(Foam::hyCompat::toScalar(Foam::hyCompat::lookup(dsmcInitialiseDict_, "electronicTemperature")))
//     );

    const vector velocity(Foam::hyCompat::lookup(Foam::hyCompat::lookup(dsmcInitialiseDict_, "velocity")));

    r0_ = Foam::hyCompat::toScalar(dsmcInitialiseDict_, "r0");

    centrePoint_ = dsmcInitialiseDict_.get<vector>("centrePoint");

    deltaT_ = Foam::hyCompat::toScalar(dsmcInitialiseDict_, "axialTemperature");
    ...
    forAll(molecules, i)
    {
        numberDensities[i] = Foam::hyCompat::toScalar
        (
            numberDensitiesDict, molecules[i]
        );
    }
    ...
    const word regionName(Foam::hyCompat::lookup(Foam::hyCompat::lookup(dsmcInitialiseDict_, "zoneName")));
